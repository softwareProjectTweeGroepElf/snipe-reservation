    ...
    $.ajax({
        ...
        success: function(data) {
            for (var i = 0; i < data.length; i++) {
                $("#outputJavascript").html("<option  value="+data[i].asset_name+">" + data[i].asset_name + "</option>");
        ...
        for (var d, i=0, z0=0; z0<6; z0++) {
            ...
            for (var z0a = 0; z0a < 7; z0a++) {
                ...
                if (d < 1){
                    ...
                    //html += '<td id="currentmonthdates">' + (d)+'<br/><br/>'+'<select id="outputJavascript"></select>' + '</td>';
                    html += '<td id="currentmonthdates">' + (d)+'<br/><br/>'+'<select id="outputJavascript" name="outputJavascript"  "></select>' + '</td>';
