                ...
                @can('reports.view')
                    <li class="treeview{{ (Request::is('reports*') ? ' active' : '') }}">
                        <a href="{{ URL::to('reports') }}"  class="dropdown-toggle">
                            ...
                            <span>@lang('Reservaties')</span>
                            <i class="fa fa-angle-left pull-right"></i>
                        </a>

                        <ul class="treeview-menu">
                            <li><a href="{{ URL::to('reservatie') }}" {{ (Request::is('reservatie') ? ' class="active"' : '') }} >@lang('Check out')</a></li>
                            <li><a href="{{ URL::to('reservatie') }}" {{ (Request::is('reservatie') ? ' class="active"' : '') }} >@lang('Check in')</a></li>
...
<br><br>
          ...
          <form class="navbar-form navbar-left form-horizontal" role="search"  method="get">
              <div class="col-xs-12 col-md-12">
                  <div class="col-xs-12 form-group">
                      <label class="sr-only" for="tagSearch">{{ trans('general.lookup_by_tag') }}</label>
                      <input type="text" class="form-control" id="tagSearch" name="assetTag" placeholder="{{ trans('general.lookup_by_tag') }}">
          ...
          <div><a style=" visibility:hidden;float:left;clear: both">Asset succesvol uitgeleend</a></div>
          <div><a style="visibility: hidden;float:left;clear:both; color:red;">Asset kan niet uitgeleend worden.</a></div>
          <br><br><br><br><br>
          ...
          <div>
              ...
              <div><a style=" visibility:hidden;float:left;clear: both">Asset succesvol ingecheckt</a></div>
  ...
  <br><br>
        ...
        <table
            ...
            <tr>
                ...
                <th data-sortable="true" data-searchable="true" data-field="AssetID" data-visible="false">{{ trans('Asset ID') }}<input type="text" id="checkAll" style="padding-left: 10px;padding-right: 10px; float: left; "></th>
