...
<script>
	...
	function searchAllAssets()
	{
		...
		$.ajax({
			type: 'GET',
			url: '/reservation/searchAllAssets',
		...
		<div id="wrapper">
			...
			<div id="submitFormSearchLen">
				...
				<form id="filter">
					...
					<input name="filter" type="radio" value="id">ID<br>
					<input name="filter" type="radio" value="name">Naam<br>
					<input name="filter" type="radio" value="asset_tag">Tag<br>
					<input name="filter" type="radio" value="serial">Serienummer<br>
				</form>
			</div>
			<br><br>
