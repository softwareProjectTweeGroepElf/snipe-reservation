...
class UsersController extends Controller
{
    ...
    * @return Redirect
    */
    public function getReupdate($id = null)
    {
        ...
        if (!Company::isCurrentUserHasAccess($user)) {
            ...
            // Reupdate the user
            if (User::withTrashed()->where('id', $id)->reupdate()) {
                return redirect()->route('users')->with('success', trans('admin/users/message.success.reupdated'));
            } else {
    ...
    */
    ...
    {
        return View::make('users/GoogleCalendar');
    }
    public function getJavascriptCalender()
    {
        return View::make('users/JavascriptCalender');
    }
